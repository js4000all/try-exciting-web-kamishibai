...
- **実装契約（必須/型/許容値）の正本は `shared/schema/scenario-v0.schema.json`** とする。
...
> 具体フィールド（必須/任意）や型、正規表現、enum は `shared/schema/scenario-v0.schema.json` を参照。
...
- スキーマ本体: `shared/schema/scenario-v0.schema.json`
- 仕様補助: `shared/specs/scenario-format-v0.md`
- 正例: `shared/schema/examples/scenario.valid.json`
